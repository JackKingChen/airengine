...
bool CAIRBone::Create(CMaxNode* pNode, int nParentId, int nID)
{
    ...
    //--------
    Quat q1(-0.041200, -0.142789, 0.684696, -0.713517);
    Quat q2(-0.068340, 0.243732, 0.042044, -0.966518);
    Quat q3 = q1 * q2;
    Quat q4 = q2 * q1;
    
    Point3 vPosPAbsolute(-0.082123, 92.597969, -0.178655);
    Point3 vPos2P(-8.584198, 0.105214, 0.533138);
  
    Matrix3 mat; 
    q1.Inverse().MakeMatrix(mat);
    Point3 child = mat.PointTransform(vPos2P);
    child += vPosPAbsolute;
    //--------------
