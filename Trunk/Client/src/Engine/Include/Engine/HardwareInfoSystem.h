...
// ***************************************************************
//  文件: HardwareInfoSystem.h
//  日期: 2010-2-26
//  作者: huangjunjie
//  说明: 用于检测系统的硬件信息，读取硬件信息表，得出当前系统的最
//        低配置和推荐配置。
// ***************************************************************
...
//    u32       mVideoCardDeviceId;                       /// 显卡id，用于识别各种型号的显卡
...
//    u32       mVideoCardVendorId;                       /// 显卡厂商Id
//    u32       mVideoDriverVersion;                      /// 驱动程序版本号
//};
//
///// 游戏中显示配置中的项
